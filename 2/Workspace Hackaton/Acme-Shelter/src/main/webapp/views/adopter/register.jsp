...
<form:form action="adopter/register.do"
	modelAttribute="adopterForm">
	...
	<fieldset>
		<legend align="left">
			<spring:message code="adopter.edit.useraccount" />
		</legend>
		...
		<form:label path="userAccount.password">
			<spring:message code="adopter.edit.label.password" />* :
		</form:label>
	...
	<form:label path="conditionsAccepted">
		<spring:message code="adopter.conditions" />:
	</form:label>
	...
	<input type="submit" name="save"
		value="<spring:message code="adopter.edit.save" />" />&nbsp;
