...
<form:form action="veterinarian/veterinarian/edit.do"
	...
	<br />
	<spring:message code="veterinarian.leave.explanation"
		var="leaveExplanation" />
	<jstl:out value="${leaveExplanation}" />

	<a href="veterinarian/veterinarian/show.do"> Link </a>

	<br />
	<input type="submit" name="save"
		value="<spring:message code="veterinarian.edit.save.save" />" />&nbsp;
	<input type="submit" name="leave"
		value="<spring:message code="veterinarian.edit.leave" />"
		onclick="return confirm('<spring:message code="veterinarian.confirm.delete" />')" />&nbsp;
