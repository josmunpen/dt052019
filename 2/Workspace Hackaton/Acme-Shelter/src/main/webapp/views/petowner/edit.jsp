...
<form:form action="petowner/petowner/edit.do"
	modelAttribute="petOwner">
	<form:hidden path="id" />
	...
	<br />
	<spring:message code="petOwner.leave.explanation"
		var="leaveExplanation" />
	<jstl:out value="${leaveExplanation}" />

	<a href="petowner/petowner/show.do"> Link </a>

	<br />
	<input type="submit" name="save"
		value="<spring:message code="petOwner.edit.save.save" />" />&nbsp;
	<input type="submit" name="leave"
		value="<spring:message code="petOwner.edit.leave" />"
		onclick="return confirm('<spring:message code="petOwner.confirm.delete" />')" />&nbsp;
